  ...
  return (
    <div className="min-h-screen w-full bg-neutral-900 text-white font-sans overflow-x-hidden">
      ...
      <main className="relative z-10 flex flex-col items-center px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] items-start gap-8 md:gap-12">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-8 pt-8">
                ...
                <div className="bg-zinc-900/50 p-6 rounded-xl ring-1 ring-white/10 shadow-lg">
                  <h4 className="text-base font-semibold text-gray-200 mb-3 flex items-center gap-2">
                    <span className="text-red-400">❌</span> Traditional
                    Workflow Problems
                  </h4>
                ...
                <div className="text-center pt-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-zinc-900/50 p-4 rounded-lg ring-1 ring-white/10 shadow-lg hover:ring-1 hover:ring-gray-300/30 transition-all duration-300">
                    ...
                    <div className="bg-zinc-900/50 p-4 rounded-lg ring-1 ring-white/10 shadow-lg hover:ring-1 hover:ring-gray-300/30 transition-all duration-300">
                      <div className="text-2xl mb-2">🎮</div>
                      <p className="text-sm text-gray-300 font-medium">Games</p>
                    </div>
                    <div className="bg-zinc-900/50 p-4 rounded-lg ring-1 ring-white/10 shadow-lg hover:ring-1 hover:ring-gray-300/30 transition-all duration-300">
                      <div className="text-2xl mb-2">🔬</div>
                      <p className="text-sm text-gray-300 font-medium">
        ...
        {/* Footer */}
        <footer className="mt-24 md:mt-32 pb-16 text-center text-gray-500">
          <p>Built with ❤️ for the R3F community.</p>
          <p>AdzyJS is an open source project.</p>
        </footer>
      </main>
    </div>
  );
